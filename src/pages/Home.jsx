...
function Home() {
  const skills = [
    'JavaScript', 'React', 'React Native', 'Java', 'Spring Boot', 'MongoDB',
    'Next.js', 'Express', 'Node.js', 'Tailwind CSS', 'HTML', 'CSS', 'Firebase'
  ];
                ...
                {[...skills, ...skills, ...skills].map((skill, index) => {
                  ...
                  return (
                    <motion.div
                      key={`${skill}-${index}`}
                      whileHover={{ scale: 1.1 }}
                      className="flex-shrink-0 w-40 h-32 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg 
